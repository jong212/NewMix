...
public class PlayerWaitRoomInfo : MonoBehaviour
{
    ...
    [SerializeField] Text accLayout;
    [SerializeField] Text missLayout;
    [SerializeField] Text luckyLayout;
    ...
    public Text AccLayout { get => accLayout; set => accLayout = value; }
    public Text MissLayout { get => missLayout; set => missLayout = value; }
    public Text LuckyLayout { get => luckyLayout; set => luckyLayout = value; }
    ...
    private void Awake()
    {
        if (nickNameLayout == null || lvLayout == null || atkLayout == null ||  accLayout == null || missLayout == null || lastLocationLayout == null || deleteCharacter == null || gameStartButton == null)
        {
